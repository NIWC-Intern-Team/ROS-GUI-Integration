...
class MainWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        #load qt designer gui framework
        uic.loadUi('ui_pyqt_ros2.ui', self)
        self.create_menubars()

        #app icon logo thingy
        self.icon_path = "images/qt_ros_logo.png"
        self.setWindowIcon(QIcon(self.icon_path))

        #initializing variables
        self.float_topic_name = 'none' #float topic currently subscribing to

        self.show()


        #if buttons pressed, do action
        self.checkBox_float_01.stateChanged.connect(self.connect_ros_float)
        self.checkBox_float_02.stateChanged.connect(self.update_ros_float)
        self.label_topic_setting_float.setText(self.float_topic_name)
        self.lineEdit_topic_float.editingFinished.connect(self.change_float_topic)
    ...
    def prefer_action(self):
        ...
        preferAct = QAction(QIcon('image/qt_settings.png'),'Setting', self)
    ...
    def change_float_topic(self):
        self.float_topic_name = self.lineEdit_topic_float.text()
        self.label_topic_setting_float.setText(self.float_topic_name)
    ...
    def update_float_data_label(self):
        self.label_data_num_float.setText(str(self.number))
        self.show()
